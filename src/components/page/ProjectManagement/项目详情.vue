    ...
    <div>
        ...
        <div class="container">
            ...
            <div class='content content3'>
                ...
                <!--分页器-->
                <el-pagination background  :current-page='currentPage' :page-sizes="[5, 10, 15]" :page-size="pageSize" layout="total, sizes, prev, pager, next,jumper" :total="total" class='page' @current-change="currentChange"> 
                </el-pagination>
            </div>
            <!-- 小区详情 -->
            <div class='content content4'>
                ...
                <el-form ref='form' :data='form.districtVo'>
                    ...
                    <el-form-item v-for="(domain, index) in form.districtVo.policyList" :key="index"  :prop="'telPhoneList.'+index+'.telPhone'" :label="'小区政策'+(index+1)+':'" style="width: 60%;margin-bottom: 0;margin-left:56px;margin-top:20px;" label-width="180px">
                            <template>
                                <div>
                                    <el-input v-model="domain.policy" :disabled="true">{{domain.policy}}</el-input>
                                </div>
                            </template>
                    </el-form-item>
                </el-form>
            ...
            <div class='content content6'>
                ...
                <el-form ref="form.controllRespDto" :data="form.controllRespDto">
                    ...
                    <el-form-item label="开盘时间">
                        <el-date-picker v-model="form.controllRespDto.startTime" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp" :disabled="true"></el-date-picker>
                        <span style="margin:0 20px;">~</span>
                        <el-date-picker v-model="form.controllRespDto.endTime" btype="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp" :disabled="true"></el-date-picker>
                    </el-form-item>
                </el-form>
            </div>
            <!-- 项目落位 -->
            <div class='content content6'>
                ...
                <el-form :data='form.controllRespDto' ref='form.controllRespDto' label-width="120px">
                    ...
                    <el-form-item label="可落位开始时间:" inline-message>
                        <template>
                            <div>
                                <el-date-picker label-width="120px" v-model="form.controllRespDto.downStartTime" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp" :disabled="true"></el-date-picker>
                                <span style="margin:0 5px;">~</span>
                                <el-date-picker label-width="120px" v-model="form.controllRespDto.downEndTime" btype="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp" :disabled="true"></el-date-picker>
                            </div>
                        </template>
                    </el-form-item>
                    <el-row>
                        <el-col :span='6'>
                            <el-form-item>
                                <el-checkbox v-model="downDelOrderCheBox"  @change="change1" :disabled="true">允许落位后取消订单</el-checkbox>
                            </el-form-item>
                        </el-col>
                        <el-col :span="18">
                            <el-form-item prop='parkNum'>
                               <template>
                                   <div class='luoweiCondition'>
                                        &nbsp;&nbsp;&nbsp;&nbsp;一个人可落<span style="margin:0 5px;">{{form.controllRespDto.downCarspaceNum}}</span>个位&nbsp;&nbsp;&nbsp;&nbsp;
                                        一个人车位可落<span  style="margin:0 5px;">{{form.controllRespDto.downLimitNum}}</span>个人
                                   </div>
                               </template>
                            </el-form-item>
                        </el-col>
                ...
                <el-form>
                    ...
                    <el-row>
                         <el-form-item label="可认购开始时间:">
                            <template>
                                <div>
                                    <el-date-picker v-model="form.controllRespDto.buyStartTime" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp" :disabled="true"></el-date-picker>
                                    <span style="margin:0 5px;">~</span>
                                    <el-date-picker  v-model="form.controllRespDto.buyEndTime" btype="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="timestamp" :disabled="true"></el-date-picker>
                                </div>
                            </template>
                        </el-form-item>
            ...
            this.$axios.get(request.testUrl+"/project/auth2/project/selectProjectInfo",{
                ...
                if(res.data.data.controllRespDto!=null){
                    ...
                    if(res.data.data.controllRespDto.openProjectStatus==1){
                        ...
                        this.form.controllRespDto.buyStartTime=res.data.data.controllRespDto.startTime;
                        this.form.controllRespDto.buyEndTime=res.data.data.controllRespDto.endTime;
                    }else{
                        //不一致 自定义的时间
                        this.form.controllRespDto=res.data.data.controllRespDto;
                        this.form.controllRespDto.buyStartTime=res.data.data.controllRespDto.buyStartTime;
                        this.form.controllRespDto.buyStartTime=res.data.data.controllRespDto.buyEndTime;
                    }
                    //落位控制 是否与开盘时间一致
                    if(res.data.data.controllRespDto.buyFollowOpen==1){
                        this.form.controllRespDto.downStartTime=res.data.data.controllRespDto.startTime;
                        this.form.controllRespDto.downEndTime=res.data.data.controllRespDto.endTime;
                    }else{
                        //不一致 自定义的时间
                        this.form.controllRespDto=res.data.data.controllRespDto;
                        this.form.controllRespDto.downStartTime=res.data.data.controllRespDto.downStartTime;
                        this.form.controllRespDto.downEndTime=res.data.data.controllRespDto.downEndTime;
                    }
                    //是否开盘 状态判断
