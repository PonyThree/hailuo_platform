  ...
  <div class="tags" v-if="showTags">
    ...
    <div class="tags-close-box">
      <el-dropdown @command="handleTags">
        ...
        <el-dropdown-menu size="small" slot="dropdown" style="">
    ...
    setTags(route) {
      ...
      if (!isExist) {
        ...
        if (route.meta.title == "项目详情") {
          if (
            route.meta.title == "新增商家" ||
            route.meta.title == "修改商家"
          ) {
          } else {
            this.tagsList.push({
          ...
          if (
            route.meta.title == "零钱提现" ||
            route.meta.title == "钱包使用详情"
          ) {
          } else if (
            route.meta.title == "项目申请提现" ||
            route.meta.title == "审核提现" ||
            route.meta.title == "审核状态"
          ) {
          } else {
            this.tagsList.push({
              title: route.meta.title,
