        ...
        <el-tab-pane label="个人资料" name="first">
          <div class="content">
                ...
                <el-form-item label="验证码:" prop="yzCode" class="yzCode">
                  <template>
                    ...
                    <el-button
                      ...
                      >获取验证码</el-button
                    >
                    <span v-else class="auth_text" style="margin-left:10px;">
                      <span
                        style="color:#409EFF;font-size:16px;margin-right:5px;"
                        >{{ auth_time }}</span
                      >秒之后重新发送验证码</span
                    >
                  </template>
            ...
            >
              ...
              <span slot="footer" class="dialog-footer footBtn">
                <el-button type="primary" @click="success" style="margin:0 auto"
                  >完成</el-button
                >
              </span>
            </el-dialog>
        ...
        <el-tab-pane label="员工管理" name="second">
          <div class="content">
            <div class="title">
              ...
              <div class="tilCon">
                <div style="float:right;">
                  ...
                  <span
                    style="color:#409EFF;font-size:16px;margin-right: 60px;"
                    >{{ name }}</span
                  >
                  <el-input
                  ...
                  ></el-input>
                  <el-button type="primary" size="small" @click="searchEmp"
                    >搜索</el-button
                  >
                </div>
              </div>
            ...
            <div class="empTable" v-loading="loading">
              <div class="addEmp">
                <el-button type="primary" @click="addEmp" size="small"
                  >新增员工+</el-button
                >
              </div>
              <el-table :data="empData">
                <el-table-column label="员工账号" prop="username">
                  <template slot-scope="scope">
                    <div>
                      <span
                        class="iconfont icon-shou"
                        style="color:#409EFF;font-size:18px;margin-right:5px;"
                      ></span>
                ...
                <el-table-column label="权限" prop="telPhone">
                  <template slot-scope="scope">
                    <el-button
                      type="text"
                      style="color:#169BD5;"
                      @click="goDetails(empData[scope.$index].id)"
                      >详情</el-button
                    >
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    <el-button
                      type="primary"
                      v-if="scope.$index !== 0"
                      @click="deleteEmp(empData[scope.$index].id)"
                      >删除</el-button
                    >
                  </template>
                </el-table-column>
            ...
            >
              ...
              >
                <el-form-item label="员工账号:" prop="empAccount">
                  <el-input
                    placeholder="请输入内容"
                    v-model="merchantForm.empAccount"
                  ></el-input>
                </el-form-item>
                ...
                <div class="txt">
                  添加完员工后方可编辑员工权限，详细权限请到权限管理设置
                </div>
                <el-form-item label="密码" prop="pass">
                  <el-input
                    type="password"
                    v-model="merchantForm.pass"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
                <el-form-item label="确认密码" prop="checkPass">
                  <el-input
                    type="password"
                    v-model="merchantForm.checkPass"
                    autocomplete="off"
                  ></el-input>
                </el-form-item>
                <el-form-item label="手机号码:" prop="telPhone">
        ...
        <el-tab-pane label="消息通知" name="third">
          <div class="content">
            ...
            <el-form
              :model="form2"
              ref="form2"
              style="width:680px;margin-left:75px;"
              class="infoForm"
            >
              <el-form-item
              ...
              >
                <template>
                  <div>
                    <el-input
                      v-model="domain.telPhone"
                      style="width: 180px;"
                    ></el-input>
                    <el-input v-model="domain.id" v-show="1 == 2"></el-input>
                    <i
                      class="iconfont icon-add_x use"
                      @click="addpromptList"
                      v-if="num == index"
                    ></i>
                    <i
              ...
              <div
                style="width:500px;margin:24px auto;font-size:14px;line-height:20px;color:#606266;text-align:center;"
              >
                一个人最多可以设置3个不同手机号接受信息
              </div>
              <div style="width:50%;margin:0 auto;">
                <el-form-item prop="checkedList" style="margin-top:30px;">
                  <div style="margin: 10px 33px;width:130px;color:#606266;">
                    设置提醒内容:
                  </div>
                  <el-checkbox-group
                    v-model="form2.checkedList"
          ...
          <div>
            ...
            <div class="content" v-if="show2">
              <div class="title">
                <span class="iconfont icon-shuxian"></span>
                <span>账号安全</span>
                <span style="margin-left:40px;font-size:14px;color:#409EFF"
                  >车位宝账号:</span
                >
                <span style="margin-left:5px;color:#409EFF;font-size:16px">{{
                  name
                }}</span>
              </div>
              <div class="accountSafe">
                ...
                <div class="box box1">
                  ...
                  <div class="con">
                    ...
                    <p>登录密码</p>
                    <p>定期更换有助于账号安全</p>
                    <el-button type="text" class="pwdBtn" @click="updatePwd"
                      >修改密码</el-button
                    >
                  </div>
                </div>
                ...
                <div class="box box2">
                  ...
                  <div class="con" style="padding-top:6px;">
                    <span
                      class="iconfont icon-bangdingshouji"
                  ...
                  >
                    <div style="font-size:14px;">
                      ...
                      <div style="margin-top:10px;">
                        <el-checkbox v-model="bindAccount"
                          >禁止此页再显示对话框。</el-checkbox
                        >
                      </div>
                    </div>
                    <span slot="footer" class="dialog-footer">
                      <el-button
                        ...
                        >确 定</el-button
                      >
                      <el-button @click="dialogVisibleAccount = false"
                        >取 消</el-button
                      >
                    </span>
                  </el-dialog>
              ...
              <div class="updateTel">
                ...
                <div class="conTel">
                  ...
                  >
                      ...
                      <template>
                        <div>
                          ...
                          <el-button
                            type="text"
                            @click="getyzCode"
                            style="color:#fff;background-color:rgb(22,155,213);margin-left:9px"
                            v-if="sendAuthCode"
                            >获取验证码</el-button
                          >
                          <span
                    ...
                    <el-form-item>
                      <el-button type="primary" @click="telNextStep"
                        >下一步</el-button
                      >
                    </el-form-item>
                  </el-form>
      ...
      <div class="content" v-if="show1">
        ...
        <div class="updateInfo">
          ...
          <el-button
            ...
            >获取验证码</el-button
          >
          <span v-else class="auth_text" style="margin-left:15px;">
            <span style="color:#409EFF;font-size:16px;margin-right:5px;">{{
              auth_time
            }}</span
            >秒之后重新发送验证码</span
          >
          <span style="color:#f66;margin-left:30px;"
            >显示手机号,中间四位为星号</span
          >
        </div>
        <el-form
...
export default {
  ...
  data() {
    ...
    return {
      ...
      rules1: {
        telPhone: [{ validator: validatePhone, trigger: "blur" }],
        yzCode: [{ required: true, trigger: "blur", message: "请输入验证码" }],
        loginPwd: [
  ...
  methods: {
    ...
    renderEmp() {
      this.$axios
        .post(
          request.testUrl + "/platform/auth2/adminUser/pageList",
          JSON.stringify({
    ...
    renderPerInfo() {
      ...
      this.$axios
        .post(request.testUrl + "/auth/platform/getLoginInfo")
        .then(res => {
          this.loading = true;
          setTimeout(() => {
            this.loading = false;
    ...
    deleteEmp(id) {
      this.$axios
        .delete(request.testUrl + "/platform/auth2/adminUser/" + id)
        .then(res => {
          if (res.data.code == 0) {
            this.$message({
              type: "success",
    ...
    submitForm(merchantForm) {
      ...
      this.$axios
        .post(
          request.testUrl + "/platform/auth2/adminUser/add",
          JSON.stringify({
