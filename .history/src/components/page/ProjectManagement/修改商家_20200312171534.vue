    ...
    <div style="width:90%;margin:0 auto;">
      ...
      >
        ...
        <el-form-item>
          <template>
            <div>
              <el-button type="primary" @click="saveInfo('form')"
                >确 定</el-button
              >
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        address: [{ required: true, message: "请输入经度", trigger: "blur" }],
        latitudes: [{ required: true, message: "请输入纬度", trigger: "blur" }],
  ...
  methods: {
    ...
    saveInfo(form) {
      ...
      if (this.form != null) {
        ...
        this.$axios
          .post(request.testUrl + "/project/auth2/project/doUpdate", params)
          .then(res => {
            if (res.data.code == 0) {
              this.$message({
                type: "success",
