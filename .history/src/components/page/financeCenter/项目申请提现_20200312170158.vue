<template>
  <div id="applicationWithdrawal">
    ...
    <el-table :data="tableData" border style="width: 94%" v-loading="loading">
      ...
      <el-table-column prop="applicantPhone" label="联系电话" align="center">
      </el-table-column>
      ...
      <el-table-column prop="canOutMoney" label="可提现金额" align="center">
      </el-table-column>
      <el-table-column
        prop="outMoney"
        label="申请提现金额（万元）"
      ...
      <el-table-column prop="accountName" label="到账地址" align="center">
      </el-table-column>
      <el-table-column prop="account" label="收款账号" align="center">
      </el-table-column>
      <el-table-column prop="modifyTime" label="审核时间" align="center">
        <!-- <template slot-scope="scope">
                <div>
      ...
      <el-table-column prop="status" label="审核状态" align="center">
        <template slot-scope="scope">
          <el-button
            @click.native.prevent="review(scope.row.id)"
            type="text"
            size="small"
            style="color:#409EFF;"
          ...
          <el-button
            @click.native.prevent="audited(scope.row.id)"
            type="text"
            size="small"
            style="color:#409EFF;"
          ...
          <el-button
            @click.native.prevent="dismissed(scope.row.id)"
            type="text"
            size="small"
            style="color:#409EFF;"
...
export default {
  ...
  methods: {
    ...
    renderTable() {
      ...
      this.$axios
        .post(
          request.testUrl + "/finance/auth2/applyMoney/getPageByPlatfrom",
          JSON.stringify({
            projectId: this.id,
