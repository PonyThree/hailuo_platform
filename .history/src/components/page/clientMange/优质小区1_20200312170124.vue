        ...
        <div v-for="(item, index) in coperationList" :key="index" class="list">
          <div class="listItem">
            <div class="upload_warp">
              <div
                class="upload_warp_left img-upload"
                @click="homeImg_file(1, item.id)"
              >
                <img
            ...
            <input
              @change="homeImg_fileChange($event, item.id)"
              type="file"
        ...
        <div v-for="(item, index) in publishProject" :key="index" class="list">
          <div class="listItem">
            ...
            <div class="pic-box">
              ...
              <input
                @change="homeImg_fileChange1($event, item.id)"
                type="file"
                id="homeImg_upload_file1"
                style="display:none;"
              />
            </div>
