...
export default {
  ...
  methods: {
    ...
    showzxList() {
      this.$axios
        .get(request.testUrl + "/platform/auth2/information/findList")
        .then(res => {
    ...
    showrwList(n1, n2) {
      this.$axios
        .get(request.testUrl + "/platform/auth2/softArticle/pageFind", {
          params: {
            page: n1,
            pageSize: n2
          }
    ...
    showLinkList() {
      this.$axios
        .get(request.testUrl + "/platform/auth2/thirdLinks/pageFind", {
          params: {
            page: 1,
            pageSize: 100
          }
    ...
    savePic1(form1) {
      ...
      this.$refs.form1.validate(valid => {
        if (valid) {
          ...
          this.$axios
            .post(
              request.testUrl + "/platform/auth2/thirdLinks/doInsertOrUpdate",
              params
            )
            .then(res => {
              if (res.data.code == 0) {
    ...
    dellj(id) {
      ...
      params.append("id", id);
      this.$axios
        .post(request.testUrl + "/platform/auth2/thirdLinks/doDelete", params)
        .then(res => {
          if (res.data.code == 0) {
            this.$message({
              type: "success",
    ...
    updatelj(id) {
      ...
      //渲染修改链接之前的单个数据
      this.$axios
        .get(request.testUrl + "/platform/auth2/thirdLinks/findOneById", {
          params: {
            id: id
          }
        })
    ...
    delzx(id) {
      ...
      params.append("id", id);
      this.$axios
        .post(request.testUrl + "/platform/auth2/information/doDelete", params)
        .then(res => {
    ...
    updatezx(id) {
      ...
      // 渲染修改之前单个的原有数据
      this.$axios
        .get(request.testUrl + "/platform/auth2/information/findOneById", {
          params: {
            id: id
          }
        })
    ...
    savePic3(form3) {
      this.$refs.form3.validate(valid => {
        if (valid) {
          ...
          this.$axios
            .post(
              request.testUrl + "/platform/auth2/information/doInsertOrUpdate",
              params
            )
            .then(res => {
              // console.log(res.data);
    ...
    savePic(form) {
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          this.$axios
            .post(
              request.testUrl + "/platform/auth2/softArticle/doInsertOrUpdate",
              params
            )
            .then(res => {
              // console.log(res.data);
    ...
    delrw(id) {
      ...
      params.append("id", id);
      this.$axios
        .post(request.testUrl + "/platform/auth2/softArticle/doDelete", params)
        .then(res => {
          // console.log(res.data.code);
          this.showrwList(this.currentPage1, this.pageSize1);
          if (res.data.code == 0) {
    ...
    updaterw(id) {
      ...
      // 渲染修改之前单个的原有数据
      this.$axios
        .get(request.testUrl + "/platform/auth2/softArticle/findOneById", {
          params: {
            id: id
          }
        })
